			  ...
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
				  ...
				  <li role="presentation"><a href="data-sub-kriteria.php"><span class="fa fa-bank"></span> Data Sub Kriteria</a></li>
			  ...
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
				  ...
				  <li role="presentation"><a href="analisa-sub-kriteria.php"><span class="fa fa-bomb"></span> Analisa Sub Kriteria</a></li>
